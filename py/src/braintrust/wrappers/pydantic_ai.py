...
def wrap_agent(Agent: Any) -> Any:
    ...
    def agent_run_stream_sync_wrapper(
        wrapped: Callable[..., Any], instance: Any, args: tuple[Any, ...], kwargs: dict[str, Any]
    ):
        _ensure_model_wrapped(instance)
        input_data, metadata = _build_agent_input_and_metadata(args, kwargs, instance)
    ...
    async def agent_run_stream_events_wrapper(
        wrapped: Callable[..., Any], instance: Any, args: tuple[Any, ...], kwargs: dict[str, Any]
    ):
        _ensure_model_wrapped(instance)
        input_data, metadata = _build_agent_input_and_metadata(args, kwargs, instance)
...
def _wrap_concrete_model_class(model_class: Any):
    ...
    async def model_request_wrapper(
        wrapped: Callable[..., Any], instance: Any, args: tuple[Any, ...], kwargs: dict[str, Any]
    ):
    ...
    def model_request_stream_wrapper(
        wrapped: Callable[..., Any], instance: Any, args: tuple[Any, ...], kwargs: dict[str, Any]
    ):
        model_name, display_name, input_data, metadata = _build_model_class_input_and_metadata(instance, args, kwargs)
...
def _build_agent_input_and_metadata(
    args: tuple[Any, ...], kwargs: dict[str, Any], instance: Any
